...
public class Network {
	...
	/**
	 * 判断有无可用状态的移动网络，注意关掉设备移动网络直接不影响此函数。 也就是即使关掉移动网络，那么移动网络也可能是可用的(彩信等服务)，即返回true。 以下情况它是不可用的，将返回false： 1. 设备打开飞行模式； 2. 设备所在区域没有信号覆盖； 3. 设备在漫游区域，且关闭了网络漫游。
	 *
	 * @return boolean
	 */
	 ...
	 *
	 * @return {@link ConnectivityManager#TYPE_WIFI}, {@link ConnectivityManager#TYPE_MOBILE}, {@link ConnectivityManager#TYPE_ETHERNET}...
	 */
	 ...
	 *
	 * @return {@link TelephonyManager#NETWORK_TYPE_CDMA}, {@link TelephonyManager#NETWORK_TYPE_GPRS}, {@link TelephonyManager#NETWORK_TYPE_LTE}...
	 */
	...
	/**
	 * GPRS 2G(2.5) General Packet Radia Service 114kbps EDGE 2G(2.75G) Enhanced Data Rate for GSM Evolution 384kbps UMTS 3G WCDMA 联通3G Universal Mobile Telecommunication System
	 * 完整的3G移动通信技术标准 CDMA 2G 电信 Code Division Multiple Access 码分多址 EVDO_0 3G (EVDO 全程 CDMA2000 1xEV-DO) Evolution - Data Only (Data Optimized) 153.6kps - 2.4mbps 属于3G EVDO_A 3G
	 * 1.8mbps - 3.1mbps 属于3G过渡，3.5G 1xRTT 2G CDMA2000 1xRTT (RTT - 无线电传输技术) 144kbps 2G的过渡, HSDPA 3.5G 高速下行分组接入 3.5G WCDMA High Speed Downlink Packet Access 14.4mbps HSUPA 3.5G
	 * High Speed Uplink Packet Access 高速上行链路分组接入 1.4 - 5.8 mbps HSPA 3G (分HSDPA,HSUPA) High Speed Packet Access IDEN 2G Integrated Dispatch Enhanced Networks 集成数字增强型网络
	 * （属于2G，来自维基百科） EVDO_B 3G EV-DO Rev.B 14.7Mbps 下行 3.5G LTE 4G Long Term Evolution FDD-LTE 和 TDD-LTE , 3G过渡，升级版 LTE Advanced 才是4G EHRPD 3G CDMA2000向LTE 4G的中间产物 Evolved High
	 * Rate Packet Data HRPD的升级 HSPAP 3G HSPAP 比 HSDPA 快些
	 *
